 ...
 */
function socialtrek_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  // If the default theme is either socialtrek or socialsaas then extend
  // the form in the appearance section.
  if ($system_theme_settings == 'socialtrek' || $system_theme_settings == 'socialsaas') {
